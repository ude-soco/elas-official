...
#### Installation Guide for NoteBot Service (Django)
...
- Open a command prompt/terminal in the `backend\7-notebot` directory with **administration rights**
...
- (TODO) Get the full set of API requests in the Postman collection located under `backend\7-notebot\docs\postman\notebot-api.json`