...
BELONGS_TO_DATA = os.path.abspath(
    os.path.join(
        data_directory, "course_belongs_to_studyprogram.json"
    )
)
HAS_INSTANCE_DATA = os.path.abspath(
    os.path.join(
        data_directory, "course_has_instance.json"
    )
)
HAS_KEYWORD_DATA = os.path.abspath(
    os.path.join(
        data_directory, "instance_has_key.json"
    )
)
HAS_TEACHER_DATA = os.path.abspath(
    os.path.join(
        data_directory, "instance_has_professor.json"
    )
)
