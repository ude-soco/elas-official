...
STUDY_PROGRAMS_DATA = os.path.abspath(
    os.path.join(
        data_directory, "study_program_infos.json"
    )
)
KEYWORD_DATA = os.path.abspath(
    os.path.join(
        data_directory, "keywords.json"
    )
)
TEACHER_DATA = os.path.abspath(
    os.path.join(
        data_directory, "professors.json"
    )
)
COURSE_DATA = os.path.abspath(
    os.path.join(
        data_directory, "courses.json"
    )
)
INSTANCE_DATA = os.path.abspath(
    os.path.join(
        data_directory, "course_instance_infos.json"
    )
)
